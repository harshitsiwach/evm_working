  ...
  return (
    ...
    <div className=' h-screen flex flex-col items-center justify-center '>
     ...
     <Swiper navigation={true} modules={[Navigation]} className="mySwiper  ">
      ...
      <div className='mb-[80px] h-[100px] flex items-center  overflow-hidden bg-blue-500 w-4/6'>
        <div className='animate-scroll gap-10 flex justify-between w-full flex-row whitespace-nowrap'>
          ...
          <svg className=' w-full max-w-xs h-[50px]' width="200" height="208" viewBox="0 0 200 208" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clip-path="url(#clip0_2303_632)">
          <path d="M132.369 155.99H49.7V68.8854H68.6147V139.109H132.369V155.981V155.99Z" fill="#121212"/>
          <path d="M132.369 85.7575C141.687 85.7575 149.241 78.2036 149.241 68.8855C149.241 59.5673 141.687 52.0134 132.369 52.0134C123.05 52.0134 115.497 59.5673 115.497 68.8855C115.497 78.2036 123.05 85.7575 132.369 85.7575Z" fill="#121212"/>
          </g>
          <defs>
          <clipPath id="clip0_2303_632">
          <rect width="99.5407" height="103.977" fill="white" transform="translate(49.7 52.0134)"/>
          </clipPath>
          </defs>
          </svg>

        
            <svg className=' w-full max-w-xs h-[50px]' width="800px" height="800px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className=' w-full max-w-xs h-[50px]' style={{ backgroundColor: 'blue' }} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
              viewBox="0 0 2000 2000" xmlSpace="preserve">
            <g id="bg">
            </g>
            <g id="Layer_1">
              <g>
                <g id="triangle-group_00000072973775570190796580000017079588389293805753_">
                  <polygon points="712.6,1248.9 593,1456.1 1407,1456.1 1287.4,1248.9"/>
                  <polygon points="1000,751.1 880.4,543.9 473.4,1248.9 712.6,1248.9"/>
                  <polygon points="1287.4,1248.9 1526.6,1248.9 1119.6,543.9 1000,751.1"/>
                </g>
                <circle id="circle-shape_00000117666210514754607560000005336158937864908958_" cx="1000" cy="1083.8" r="129.5"/>
              </g>
            </g>
          </svg>


          <svg className=' w-full max-w-xs h-[50px]' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 2500 2500" xmlSpace="preserve">
          <g id="Layer_x0020_1">
            <g id="_2187289728928">
              <rect y="0" width="2500" height="2500" style={{ fill: 'none' }}></rect>
              <g>
                <path d="M1464.3,1015.3h-405.2c-17.2,0-31.3,14.1-31.3,31.3v405.2c0,17.2,14.1,31.3,31.3,31.3h405.2c17.2,0,31.3-14.1,31.3-31.3v-405.2C1495.6,1029.4,1481.5,1015.3,1464.3,1015.3z"></path>
                <path d="M996.6,549.1H591.4c-17.2,0-31.3,14.1-31.3,31.3v405.2c0,17.2,14.1,31.3,31.3,31.3h405.2c17.2,0,31.3-14.1,31.3-31.3V580.4C1027.8,563.2,1013.8,549.1,996.6,549.1z"></path>
                <path d="M1930.5,549.1h-405.2c-17.2,0-31.3,14.1-31.3,31.3v405.2c0,17.2,14.1,31.3,31.3,31.3h405.2c17.2,0,31.3-14.1,31.3-31.3V580.4C1961.8,563.2,1947.7,549.1,1930.5,549.1z"></path>
                <path d="M996.6,1481.5H591.4c-17.2,0-31.3,14.1-31.3,31.3V1918c0,17.2,14.1,31.3,31.3,31.3h405.2c17.2,0,31.3-14.1,31.3-31.3v-405.2C1027.8,1495.6,1013.8,1481.5,996.6,1481.5z"></path>
                <path d="M1930.5,1481.5h-405.2c-17.2,0-31.3,14.1-31.3,31.3V1918c0,17.2,14.1,31.3,31.3,31.3h405.2c17.2,0,31.3-14.1,31.3-31.3v-405.2C1961.8,1495.6,1947.7,1481.5,1930.5,1481.5z"></path>
              </g>
            </g>
          </g>
        </svg>
