    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.box}>
          ...
          <p className={styles.paragraph}>
          If you have any questions about this Policy, our practices regarding your personal information related to the Site or Game, or if you would like to have us remove your information from our database and deactivate your Account, please contact us at <Link className='text-red-600' target="_blank" rel="noopener noreferrer" href='https://evmwarfare.com/'>evmwarfare@proton.me</Link> or reach out to us via our social media platforms <Link className='text-red-600' target="_blank" rel="noopener noreferrer"  href='https://twitter.com/evmwarfare'> [Twitter / X]</Link> <Link className='text-red-600' target="_blank" rel="noopener noreferrer" href="https://discord.com/invite/H42wMEXrbg">[Discord]</Link> <Link className='text-red-600' target="_blank" rel="noopener noreferrer" href='https://www.instagram.com/evm_warfare/'>[Instagram]</Link> . We will respond to your request to access within 7 days. We are here to assist you and address your concerns.
